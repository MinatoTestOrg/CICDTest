...
public abstract class TestTable1BaseController<SERVICE extends ITestTable1BaseService<M>, M extends TestTable1Base>
		extends BaseWebService<SERVICE, M> {
	
	
	public TestTable1BaseController(SERVICE logic) {
		super(logic);
	}
	@PreAuthorize("hasAccess('/testtable1s/datatable')")
	...
	@PreAuthorize("hasAccess('/testtable1s/autosuggest')")
	...
	@PreAuthorize("hasAccess('/testtable1s/{sid}')")
	...
	@PreAuthorize("hasAccess('/testtable1s/')")
	@PutMapping
	...
	@PreAuthorize("hasAccess('/testtable1s/{ids}')")
	@DeleteMapping("/{ids}")

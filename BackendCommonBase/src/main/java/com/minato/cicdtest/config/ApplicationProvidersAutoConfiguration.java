package com.minato.cicdtest.config;
...
public class ApplicationProvidersAutoConfiguration {
    ...
    public IExecutionManager taskExecutionManager() {
        return new GaeTaskExecution(applicationConfiguration,txnMgr, gaeTaskExecutionHandler, cache, taskService,credentialFactory,env);
    }
}